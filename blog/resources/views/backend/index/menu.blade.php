...
<head>
	...
	<script type="text/javascript" src="{{asset('backends/js/global.js')}}"></script>
	<script type="text/javascript" src="{{asset('backends/js/utils.js')}}"></script>
	<script type="text/javascript" src="{{asset('backends/js/transport.js')}}"></script>
	<style type="text/css">
	...
	<div id="tabbar-div">
		<p>
			<span style="float:right; padding: 3px 5px;">
				<a href="javascript:toggleCollapse();"><img id="toggleImg" src="{{asset('backends/images/menu_minus.gif')}}" width="9" height="9" border="0" alt="闭合"></a>
			</span>
		...
		<div id="menu-list">
			<ul id="menu-ul">
				<li class="explode" key="02_cat_and_goods" name="menu"> 商品管理        
					<ul>
						  <li class="menu-item"><a href="{{url('backend/shopList')}}" target="main-frame">商品列表</a></li>
						  <li class="menu-item"><a href="{{url('backend/shopAdd')}}" target="main-frame">添加新商品</a></li>
						  <li class="menu-item"><a href="{{url('backend/shopClassify')}}" target="main-frame">商品分类</a></li>
						  <li class="menu-item"><a href="{{url('backend/shopBrand')}}" target="main-frame">商品品牌</a></li>
                          <li class="menu-item"><a href="{{url('backend/shopType')}}" target="main-frame">商品类型</a></li>
				...
				<li class="explode" key="04_order" name="menu"> 订单管理        
					<ul style="display: block;">
						<li class="menu-item"><a href="{{url('backend/orderList')}}" target="main-frame">订单列表</a></li>
						<li class="menu-item"><a href="{{url('backend/orderQuery')}}" target="main-frame">订单查询</a></li>
						<!-- <li class="menu-item"><a href="goods_booking.php?act=list_all" target="main-frame">缺货登记</a></li> -->
						<li class="menu-item"><a href="{{url('backend/orderListAdd')}}" target="main-frame">添加订单</a></li>
						<li class="menu-item"><a href="{{url('backend/sendList')}}" target="main-frame">发货单列表</a></li>
						<li class="menu-item"><a href="{{url('backend/backList')}}" target="main-frame">退货单列表</a></li>
					</ul>
				</li>
				<li class="explode" key="08_members" name="menu"> 用户管理        
					<ul style="display: block;">
            <li class="menu-item"><a href="{{url('backend/userList')}}" target="main-frame">用户列表</a></li>
						<li class="menu-item"><a href="{{url('backend/vipList')}}" target="main-frame">会员列表</a></li>
						<li class="menu-item"><a href="{{url('backend/vipListAdd')}}" target="main-frame">添加会员</a></li>
				...
				<li class="collapse" key="10_priv_admin" name="menu"> 权限管理        
					<ul style="display: none;">
						<li class="menu-item"><a href="{{url('backend/adminList')}}" target="main-frame">管理员列表</a></li>
						<li class="menu-item"><a href="{{url('backend/adminLog')}}" target="main-frame">管理员日志</a></li>
						<li class="menu-item"><a href="{{url('backend/adminRole')}}" target="main-frame">角色管理</a></li>
