...
<span class="action-span1"><a href="{{url('backend/main')}}">SHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 添加属性 </span>
...
<div class="main-div">
  ...
  <table width="100%" id="general-table">
      <tbody><tr>
        ...
        <td>
          <input type="text" name="a_name" value="" size="30">
      ...
      <tr>
        ...
        <td>
          <textarea name="a_value" cols="30" rows="5"></textarea>
        </td>
      </tr>
      <tr>
        <td colspan="2">
