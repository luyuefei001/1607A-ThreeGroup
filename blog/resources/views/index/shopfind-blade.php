                            ...
                            <nav class="main-navigation">
                                <ul class="mainmenu">
                                    <li class="mainmenu__item menu-item-has-children has-children">
                                        <a href="index.html" class="mainmenu__link">家</a>
                                        <ul class="sub-menu">
                                            <li><a href="index.html">家 1</a></li>
                                            <li><a href="index-2.html">家 2</a></li>
                                            <li><a href="index-3.html">家 3</a></li>
                                            <li><a href="index-4.html">家 4</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="mainmenu__item menu-item-has-children has-children">
                                        <a href="blog.html" class="mainmenu__link">博客</a>
                                        <ul class="sub-menu">
                                    ...
                                    <li class="mainmenu__item menu-item-has-children has-children">
                                        <a href="#" class="mainmenu__link">页</a>
                                        <ul class="sub-menu">
                                    ...
                                    <li class="mainmenu__item">
                                        <a href="about.html" class="mainmenu__link">关于我们</a>
                                    </li>
                                    <li class="mainmenu__item">
                                        <a href="contact.html" class="mainmenu__link">联系我们</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        <h1 class="page-title">产品Detalis</h1>
                        <ul class="breadcrumb justify-content-center">
                            <li><a href="index.html">家</a></li>
                            <li><a href="shop.html">商店</a></li>
                            <li class="current"><a href="product-details.html">产品详情选项卡样式打开</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <div class="product-details-content"> 
                                    <div class="product-details-top">
                                        ...
                                        <div class="ratings-wrap">
                                            ...
                                            <span>
                                                <a class="review-btn" href="#singleProductTab">1 评论</a>
                                                <a class="review-btn" href="#singleProductTab">发表评论</a>
                                            </span>
                                        </div>
                                        <ul class="product-details-list list-unstyled">
                                            <li>品牌: <a href="">Apple</a></li>
                                            <li>产品代码: Watches</li>
                                            <li>奖励积分: 600</li>
                                            <li>库存: In Stock</li>
                                        </ul>
                                    ...
                                    <div class="product-details-bottom">
                                        ...
                                        <div class="product-details-action-wrapper mb--20">
                                            ...
                                            <div class="product-details-action-bottom">
                                                <a href="wishlist.html">+加入愿望单</a>
                                                <a href="compare.html">+加入比较</a>
                                            </div>
                                        </div>  
                                        <p class="product-details-tags">
                                            标签: <a href="shop.html">运动</a>,
                                            <a href="shop.html">豪华</a>
                                        </p> 
                            ...
                            <div class="col-12">
                                <ul class="product-details-tab-head nav nav-tab" id="singleProductTab" role="tablist">
                                    <li class="nav-item product-details-tab-item">
                                        <a class="nav-link product-details-tab-link active" id="nav-desc-tab" data-toggle="tab" href="#nav-desc" role="tab" aria-controls="nav-desc" aria-selected="true">描述</a>
                                    </li>
                                    <li class="nav-item product-details-tab-item">
                                        <a class="nav-link product-details-tab-link" id="nav-details-tab" data-toggle="tab" href="#nav-details" role="tab" aria-controls="nav-details" aria-selected="true">附加信息</a>
                                    </li>

                                    <li class="nav-item product-details-tab-item">
                                        <a class="nav-link product-details-tab-link" id="nav-review-tab" data-toggle="tab" href="#nav-review" role="tab" aria-controls="nav-review" aria-selected="true">评论 (2)</a>
                                    </li>
                                </ul>
                                <div class="product-details-tab-content tab-content">
                                    ...
                                    <div class="tab-pane" role="tabpanel" id="nav-review" aria-labelledby="nav-review-tab">
                                        <div class="product-details-review-wrap">
                                            ...
                                            <h2 class="mb--20">添加评论</h2>
                                            <form class="form form--review">
                                                <div class="form__group clearfix mb--20">
                                                    <label class="form__label d-block" >你的评分</label>
                                                    <div class="rating">
                                                ...
                                                <div class="form__group clearfix mb--20">
                                                    <label class="form__label d-block" for="review_name">名称 <sup>*</sup></label>
                                                    <input id="review_name" name="review_name" class="form__input">
                                                </div>
                                                <div class="form__group clearfix mb--20">
                                                    <label class="form__label d-block" for="review_email">邮件 <sup>*</sup></label>
                                                    <input id="review_email" name="review_email" class="form__input">
                                                </div>
                                                <div class="form__group clearfix mb--20">
                                                    <label class="form__label d-block" for="review">您的评论 <sup>*</sup></label>
